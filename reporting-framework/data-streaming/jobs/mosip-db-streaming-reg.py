...
if __name__ == "__main__":
     sc = SparkContext(appName="KafkaStreamFromRegDB")
     ...
     indexname = config.get("ElasticSearchSection", "reg-indexname")     
     ...
     def sendRecord(rdd):
 	 ...
 	 #collect the RDD to a list
  	 ...
  	 for element in list_elements:
             ...
             record['center_id'] = record['id'][0:5]
             record['date'] = convertEpochDate(record['upd_dtimes'])

	     reg_trn_dtimes = convertEpochDateTime(record['latest_trn_dtimes'])
             ...
             record['latest_trn_dtimes'] = reg_trn_dtimes
